      ...
      <div className="about-page">
          ...
          <CustomScroll heightRelativeToParent="calc(100% - 20px)">
            <div className="page-content">
              ...
              <h1>I'm Ishan Avasthi.</h1>
              <p>Yes the same name as the boy in <strong>Taare Zameen Par (Like Stars on Earth).</strong> I saw that movie in 2008 and I decided to keep my name Ishan. :)</p>
              <p>I'm a 17-year-old developer based in India. I specialize in JavaScript and my main area of interest is Front-End Development. I love developing tools/sites/apps that solve real problems or help make someone's life easier. I like impactful work.</p>
              <h3>Skills</h3>
              <p>My current skill set includes <strong>JavaScript</strong>, <strong>React</strong>, <strong>Redux</strong>, <strong>Firebase</strong>, <strong>SASS</strong>, <strong>Bootstrap</strong>, <strong>CSS</strong>, <strong>HTML</strong> etc. </p>
